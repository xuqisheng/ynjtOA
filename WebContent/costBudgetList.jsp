...
<head>
	...
	<table>
			...
			<tr>
				...
				<td colspan="10" class="tdPHeaderR"><s:a action="CostBudgetAction_findAllValidCostBudgets" namespace="/">查看所有有效成本预算</s:a></td>
			</tr>
			<tr>
				<td colspan="20" style="height: 5px"></td>
			</tr>
		...
		<s:else>
			...
			<table>
				<thead>
					...
					<tr>
						<td colspan="20" class="tdHeader">成本预算管理:</td>
					</tr>
					<tr>
						<!-- 输出分页条 -->
				...
				<tbody>
					<s:iterator value="allCostBudgets" status="st">
						...
						<tr>
							...
							<td ><s:textfield name="allCostBudgets[%{#st.index}].mark" cssStyle="width:100px" readonly="true"/></td>
