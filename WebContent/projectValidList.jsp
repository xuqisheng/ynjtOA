...
<head>
	...
	<table>
			...
			<tr>
				...
				<td colspan="10" class="tdPHeaderR"><s:a action="ProjectAction_findAllProjects" namespace="/">查看所有项目</s:a></td>
			</tr>
			<tr>
				<td colspan="20" style="height: 5px"></td>
			</tr>
		</table>
		<s:if test="allProjects.isEmpty() == true">目前您没有任何有效项目!</s:if >
		<s:else>
			...
			<table>
				<thead>
					...
					<tr>
						<td colspan="10" class="tdHeader">项目管理:</td>
					</tr>
					<tr>
						<!-- 输出分页条 -->
